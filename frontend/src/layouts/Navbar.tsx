        ...
        <div className="flex items-center gap-4">
          {!isLoading && isAuthenticated ? (
            <>
              <Link
                to="/dashboard"
                className="flex items-center gap-2 px-4 py-1.5 rounded-full text-sm font-medium text-text-secondary hover:text-text-primary border border-transparent hover:bg-bg-elevated/50 transition-all duration-200"
              >
